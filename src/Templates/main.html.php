...
<div class="row">
    ...
    <div class="col-md-offset-3 col-md-6">
        <div class="h-100 p-5 bg-light border rounded-3 mt-5">
            ...
            <button class="btn btn-outline-secondary" type="button"><a style="text-decoration: none; color: black;" href="/authorization">Authorization</a></button>
            <button class="btn btn-outline-secondary" type="button"><a style="text-decoration: none; color: black;" href="/registration">Registration</a></button>
        </div>
    </div>
    <div class="col-3"></div>
</div>